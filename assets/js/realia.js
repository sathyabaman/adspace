...
function InitPriceSlider() {
    ...
    jQuery('.price-value .from').currency({ region: 'SLR', thousands: ' ', decimal: ',', decimals: 0 });

    jQuery('.price-value .to').text(100000000);
    jQuery('.price-value .to').currency({ region: 'SLR', thousands: ' ', decimal: ',', decimals: 0 });
