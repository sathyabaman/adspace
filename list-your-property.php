                ...
                <div class="span4">
					...
					<div class="property-type control-group">
                        ...
                        <div class="controls">
                            ...
                            <select id="inputPropertyPropertyType" name="category" onChange="handleSelection(value)">
                                
                                                <option value="prselect">Select Property Type</option> 
...
else if (choice=='Appartment')
	{
	  document.getElementById('House').style.display="block";
	  document.getElementById('Land').style.display="none";		
	}

else if (choice=='Holiday Resorts')
	{
	  document.getElementById('House').style.display="block";
	  document.getElementById('Land').style.display="none";		
	}
	  ...
	  document.getElementById('Land').style.display="none";		
			...
			<div class="control-group">
                        ...
                        <div class="controls"  style="margin-right:15%;">
                            <textarea  name="description" required value="" id="inputPropertyNotes"></textarea>
                        </div><!-- /.controls -->
                    </div><!-- /.control-group -->
